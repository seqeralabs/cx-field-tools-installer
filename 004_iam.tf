...
## IAM template files
## ------------------------------------------------------------------------------------
data "template_file" "instance_assume_role_policy" {
  template              = templatefile("assets/src/aws/iam_trust_policy_ec2.json.tpl", {} )
}


data "template_file" "instance_role_policy_main" {
  template              = templatefile( "assets/src/aws/iam_role_policy_ec2.json.tpl", 
    { 
...
data "template_file" "instance_role_policy_ses" {
  template              = templatefile( "assets/src/aws/iam_role_policy_ses.json.tpl",  {} )
}


data "template_file" "lt_content_raw" {
  template              = templatefile( "assets/src/aws/launch_template_ec2.tpl", {} )
}
...
resource "aws_iam_role" "ec2" {
  ...
  assume_role_policy    = data.template_file.instance_assume_role_policy.rendered
}
...
resource "aws_iam_policy" "main_policy" {
  ...
  policy                = data.template_file.instance_role_policy_main.rendered
}
...
resource "aws_iam_policy" "ses_policy" {
  ...
  policy                = data.template_file.instance_role_policy_ses.rendered
}
