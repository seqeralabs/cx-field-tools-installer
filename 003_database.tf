...
resource "aws_elasticache_cluster" "redis" {
  ...
  engine          = "redis"
  node_type       = var.redis_elasticache.node_type
  num_cache_nodes = var.redis_elasticache.num_cache_nodes
  # parameter_group_name = "default.redis7.0.4"
  engine_version = var.redis_elasticache.engine_version
  port           = var.redis_elasticache.port
