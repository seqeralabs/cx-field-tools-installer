...
variable "data_studio_list_max_allowed" { type = string }
variable "flag_studio_private_by_default" { type = bool }
variable "data_studio_feature_manifest_url" { type = string }
...
variable "data_studio_metrics_retention_days" { type = string }
...
variable "data_studio_wave_custom_image_name_strategy" { type = string }
variable "data_studio_wave_status_check_initial_delay" { type = string }
variable "data_studio_wave_status_check_rate" { type = string }
