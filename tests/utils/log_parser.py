...
from log_formatter import PytestLogFormatter
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Parse pytest structured logs for LLM analysis"
    )
    ...
    parser.add_argument(
        '--log-file',
        type=str,
        help='Path to log file (default: tests/logs/pytest_structured.log)'
    )
    
    parser.add_argument(
        '--recent',
        type=int,
        help='Limit to N most recent entries'
    )
