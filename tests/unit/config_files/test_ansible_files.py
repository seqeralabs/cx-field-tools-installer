...
""")
def test_002_all_present(generated_test_files):
...
""")
def test_006_all_present(generated_test_files):
    """Confirm that all conditional blocks are present."""
    ansible_file_06 = FileHelper.read_file(f"{generated_test_files['ansible_06_run_seqerakit']['filepath']}")
...
@pytest.mark.tfvars("""
    ...
    flag_enable_groundswell       = false
""")
def test_006_none_present(generated_test_files):
    """Confirm that no conditional blocks are present."""
    ansible_file_06 = FileHelper.read_file(f"{generated_test_files['ansible_06_run_seqerakit']['filepath']}")
