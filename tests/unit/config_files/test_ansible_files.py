...
""")
def test_002_all_present(staged_scenario):
    """Confirm that all conditional blocks are present."""
    ansible_file_02 = FileHelper.read_file(f"{staged_scenario['ansible_02_update_file_configurations']['filepath']}")
...
""")
def test_002_none_present(staged_scenario):
...
@pytest.mark.tfvars("""
    ...
    flag_enable_groundswell       = true
""")
def test_005_all_present(staged_scenario):
    """Confirm that all conditional blocks are present."""
    ansible_file_05 = FileHelper.read_file(f"{staged_scenario['ansible_05_patch_groundswell']['filepath']}")
...
@pytest.mark.tfvars("""
    ...
    flag_enable_groundswell       = false
""")
def test_005_none_present(staged_scenario):
    """Confirm that no conditional blocks are present."""
    ansible_file_05 = FileHelper.read_file(f"{staged_scenario['ansible_05_patch_groundswell']['filepath']}")
...
""")
def test_006_all_present(staged_scenario):
    """Confirm that all conditional blocks are present."""
    ansible_file_06 = FileHelper.read_file(f"{staged_scenario['ansible_06_run_seqerakit']['filepath']}")
...
@pytest.mark.tfvars("""
    ...
    flag_enable_groundswell       = false
""")
def test_006_none_present(staged_scenario):
    """Confirm that no conditional blocks are present."""
    ansible_file_06 = FileHelper.read_file(f"{staged_scenario['ansible_06_run_seqerakit']['filepath']}")
