...
def generate_tower_env_entries_all_active(overrides={}):
    baseline = {
        "present": {
            ...
            "TOWER_DATA_STUDIO_TEMPLATES_XPRA-6-2-R2-0-9-0_ICON": "xpra",
            "TOWER_DATA_STUDIO_TEMPLATES_XPRA-6-2-R2-0-9-0_REPOSITORY": "public.cr.seqera.io/platform/data-studio-xpra:6.2-r2-1-0.9.0",
            "TOWER_DATA_STUDIO_TEMPLATES_XPRA-6-2-R2-0-9-0_TOOL": "xpra",
            "TOWER_DATA_STUDIO_TEMPLATES_XPRA-6-2-R2-0-9-0_STATUS": "recommended",
            # ---
