...
BEGIN
   IF NOT EXISTS (
      ...
      WHERE rolname = SINGLEQUOTEREPLACEME${username}SINGLEQUOTEREPLACEME ) THEN
      CREATE ROLE postgres LOGIN PASSWORD SINGLEQUOTEREPLACEMEmypassSINGLEQUOTEREPLACEME;
   END IF;
END
$$;
