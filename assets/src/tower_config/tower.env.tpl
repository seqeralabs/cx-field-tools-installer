...
TOWER_DATA_STUDIO_TEMPLATES_JUPYTER_REPOSITORY: 'cr.seqera.io/public/data-studio-jupyter:rc'
TOWER_DATA_STUDIO_TEMPLATES_JUPYTER_ICON: 'jupyter'
TOWER_DATA_STUDIO_TEMPLATES_JUPYTER_TOOL: 'jupyter'
TOWER_DATA_STUDIO_TEMPLATES_JUPYTER_PORT: '8080'
TOWER_DATA_STUDIO_TEMPLATES_RSTUDIO_REPOSITORY: 'cr.seqera.io/public/data-studio-rstudio:rc'
TOWER_DATA_STUDIO_TEMPLATES_RSTUDIO_ICON: 'rstudio'
TOWER_DATA_STUDIO_TEMPLATES_RSTUDIO_TOOL: 'rstudio'
TOWER_DATA_STUDIO_TEMPLATES_RSTUDIO_PORT: '8787'
TOWER_DATA_STUDIO_TEMPLATES_VSCODE_REPOSITORY: 'cr.seqera.io/public/data-studio-vscode:rc'
TOWER_DATA_STUDIO_TEMPLATES_VSCODE_ICON: 'vscode'
TOWER_DATA_STUDIO_TEMPLATES_VSCODE_TOOL: 'vscode'
TOWER_DATA_STUDIO_TEMPLATES_VSCODE_PORT: '3000'
%{ endif }
