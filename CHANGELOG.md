...
| Modified | Studios | `data_studio_container_version` | Updated from 0.9.0 to 0. Note: Studios SSH requires connect-proxy >= 0.10.0. [`#332`](https://github.com/seqeralabs/cx-field-tools-installer/issues/332) |
