...
output "tower_server_url"           { value = var.tower_server_url }
...
output "aws_ec2_pubic_ip"           { value = var.flag_make_instance_public == true ? aws_eip.towerhost[0].public_ip : "EC2 has no public IP." }
